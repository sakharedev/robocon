    ...
    def __init__(self):
        ...
        self.declare_parameters(
            ...
            parameters=[
                ...
                ('height', 240),
                ('burger_mode', False),
                ('frame_id_1', 'camera_frame_1'),
                ('frame_id_2', 'camera_frame_2')
            ]
        )
        ...
        self.pub1 = self.create_publisher(Image, '/camera_right/image_1', qos_profile)
        self.pub2 = self.create_publisher(Image, '/camera_right/image_2', qos_profile)
